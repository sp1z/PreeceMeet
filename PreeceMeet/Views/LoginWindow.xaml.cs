...
public partial class LoginWindow : Window
{
    ...
    // Set after successful login+TOTP; consumed by App.xaml.cs.
    ...
    private async Task DoLoginAsync()
    {
        ...
        try
        {
            ...
            {
                var totpWindow = new TotpWindow(_authService, loginResult.TempToken);
                totpWindow.Owner = this;
            ...
            {
                ShowError("Server did not request TOTP – unexpected flow. Please contact support.");
            }
        }
        catch (Exception ex)
        {
