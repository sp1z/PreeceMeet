...
/// <summary>
/// A single video tile for one participant.
/// Renders an incoming VideoTrack via a WriteableBitmap updated on every frame.
/// </summary>
public partial class VideoTileControl : UserControl
{
    ...
    {
        // Marshal to UI thread for WPF rendering.
    ...
    private void RenderFrame(VideoFrame frame)
    {
        ...
        try
        {
            // LiveKit .NET SDK provides ARGB/BGRA data via CopyTo.
            // The frame is converted to Bgr32 compatible layout.
    ...
    // ── Remote participant event handlers ─────────────────────────────────────
